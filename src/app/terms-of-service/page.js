      ...
      <div className=" shadow-md rounded-lg p-8 max-w-md w-full space-y-4">
        ...
        <div className="prose">
          ...
          <p className="text-sm text-white/90">
            All ticket sales are final, and no refunds will be issued. Entry to
            the event is only permitted with a valid ticket. The event
            organizers reserve the right to refuse entry to anyone for any
            reason. Attendees must be of legal drinking age and will be required
            to present valid ID upon entry.
          </p>
        </div>
        <div className="prose">
          <li className="text-base my-4 border-b-2 border-accent w-fit ">
          ...
          <p className="text-sm text-white/90">
            ...
            must present valid ID upon request. Minors are not allowed to attend
            the event, and their entry will be strictly prohibited.
          </p>
        </div>
        <div className="prose">
          <li className="text-base my-4 border-b-2 border-accent w-fit ">
          ...
          <p className="text-sm text-white/90">
            All attendees are expected to conduct themselves in a respectful and
            responsible manner. Disruptive or inappropriate behavior will not be
            tolerated, and attendees may be asked to leave the event premises.
            Attendees are responsible for any damage caused to the venue or harm
            to others.
          </p>
        </div>
        <div className="prose">
